...
<head>
    ...
    <title>verified transactions</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                          ...
                          <div class="row mx-auto">
                            <form class="form-inline">
                                <div class="form-group">
                                    <input type="text" name="" id="" class="form-control" placeholder="search for a transaction" aria-describedby="helpId">
                                </div>
                            </form>
                          </div>
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                $sql = "SELECT * FROM `tblpayment` WHERE payment_status='Verified' ORDER BY `payment_id` DESC";
                                        ...
                                        while ($payment = mysqli_fetch_assoc($result)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else if ($payment['payment_status'] == 'Paid, Not Verified') { ?>
                                                ...
                                                <td>
                                                    <div class="row mr-auto d-flex justify-content-around">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <a href="transactions.php?Id=<?php echo $payment['payment_id'] ?>">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; shopi <?php  $date= date("Y"); echo $date; ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
